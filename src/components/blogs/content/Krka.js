...
const Blog = () => {
  ...
  const galleryPreviewImages = getGalleryPreviewImages('krka')
  return (
    <>
      <Container>
        ...
        <BlogContainer>
          ...
          <JustifiedGallery imgUrls={galleryPreviewImages} rowHeight={150} onImgClick={() => history.push('/gallery/krka')}/>
          <BlogPreview />
        </BlogContainer>
      </Container>
    </>
