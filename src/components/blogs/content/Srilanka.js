...
const Blog = () => {
  ...
  const galleryPreviewImages = getGalleryPreviewImages('srilanka')
  return (
    <>
      <Container>
        ...
        <BlogContainer>
          ...
          <JustifiedGallery imgUrls={galleryPreviewImages} rowHeight={150} onImgClick={() => history.push('/gallery/srilanka')}/>
        </BlogContainer>
      </Container>
    </>
  )
