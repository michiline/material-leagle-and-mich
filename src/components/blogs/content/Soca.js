...
const Blog = () => {
  ...
  const galleryPreviewImages = getGalleryPreviewImages('soca')
  return (
    <>
      <Container>
        ...
        <BlogContainer>
          ...
          <JustifiedGallery imgUrls={galleryPreviewImages} rowHeight={150} onImgClick={() => history.push('/gallery/soca')}/>
          <BlogPreview />
        </BlogContainer>
      </Container>
    </>
