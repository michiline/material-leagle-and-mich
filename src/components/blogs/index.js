...
import { Kuba, Soca, Krka, Tara, Kamacnik, Motovun, Srilanka, SrilankaBeaches, Srilanka10 } from './content'

const Blogs = ({ match }) => {
  return (
    <Switch>
      <Route exact path={match.path} component={Home} />
      <Route exact path={`${match.path}/srilanka-10`} component={Srilanka10} />
